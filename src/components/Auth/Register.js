        ...
        <main className='content-container '>
            <div className="mb-80 p-4 w-full max-w-sm bg-white rounded-lg border border-gray-200 shadow-md sm:p-6 md:p-8 dark:bg-gray-800 dark:border-gray-700">
                <form>
                    ...
                    <div className=" mb-6 w-full group">
                        <label htmlFor="password" className="block mb-2 text-sm font-medium text-gray-600 dark:text-gray-300">Confirm password</label>
                        <input type="password" name="password" id="password" placeholder="********" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white" required />
                    </div>
                    <div className="grid md:grid-cols-2 md:gap-4">
                        <div className="relative z-0 mb-6 w-full group">
                            <label htmlFor="firstname" className="block mb-2 text-sm font-medium text-gray-600 dark:text-gray-300">First name </label>
                        ...
                        <div className="relative z-0 mb-6 w-full group">
                            <label htmlFor="lastname" className="block mb-2 text-sm font-medium text-gray-600 dark:text-gray-300">Last name </label>
                    ...
                    <div className="mb-6 w-full group">
                        <label htmlFor="gender" className="block mb-2 text-sm font-medium text-gray-600 dark:text-gray-300">Gender</label>
                    ...
                    <div className="grid md:grid-cols-2 md:gap-4">
                        <div className="mb-6 w-full group">
                            <label htmlFor="firstname" className="block mb-2 text-sm font-medium text-gray-600 dark:text-gray-300">Occupation</label>
                        ...
                        <div className="mb-6 w-full group">
                            <label htmlFor="company" className="block mb-2 text-sm font-medium text-gray-600 dark:text-gray-300">Company</label>
                    ...
                    <fieldset className="my-7  w-full flex flex-col">
                        ...
                        <div className=" mb-4">
                            ...
                            <label htmlFor="terms" className="ml-2 text-sm font-medium text-gray-600 dark:text-gray-300">I agree to the <Link to="/coming-soon" className="text-outrageousOrange hover:underline dark:text-erin">terms and conditions</Link>.</label>
                        </div>
                        <div className="">
                            ...
                            <label htmlFor="agebox" className="ml-2 text-sm font-medium text-gray-900 dark:text-gray-300" >I am 18 years or older</label>
                        </div>
                    </fieldset>
